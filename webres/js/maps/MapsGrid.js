Ext.define('MapsGrid', {
    ...
    initColumns: function() {
        ...
        this.columns = [            
            ...
            {header: 'Ширина', align: 'left', width: 160, dataIndex: 'w', editor: new Ext.form.TextField({ allowBlank: false })  },
            {header: 'Высота', align: 'left', width: 110, dataIndex: 'h', editor: new Ext.form.TextField({ allowBlank: false }) },
